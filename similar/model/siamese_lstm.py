...
class SiameseLSTM(object):
    ...
    def _build_graph(self):
        ...
        with tf.name_scope('lstm_layer'):
            ...
            _, (_, output_cell1) = tf.nn.dynamic_rnn(cell1, embedded_sent1, dtype=tf.float32)
            _, (_, output_cell2) = tf.nn.dynamic_rnn(cell1, embedded_sent2, dtype=tf.float32)
    ...
    def _train_one_batch(self, sent1, sent2, label):
        feed_dict = {
